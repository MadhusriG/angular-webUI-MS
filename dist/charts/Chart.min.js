/*!
##########################CUSTOMIZED FOR TOOL TIP IN STATISTICS PIE CHART#############################################
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					...
					return datasetLabel ;//CUSTOM + ': ' + tooltipItem.xLabel;
				}
			}
		}
	};
	...
	defaults.doughnut = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.index] ;//CUSTOM + ': ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index];
				}
			}
		}
	};
	...
	Chart.defaults.polarArea = {
		...
		tooltips: {
			callbacks: {
				...
				label: function(tooltipItem, data) {
					return data.labels[tooltipItem.index] ;//CUSTOM + ': ' + tooltipItem.yLabel;
				}
			}
		}
	};
